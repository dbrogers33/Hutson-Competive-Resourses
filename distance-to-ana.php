...
<!-- map.js -->
<script src="js/employeesana.js" type="text/javascript"></script>

</head>
<body>
    
<div class="page"> 
<a href="/distance-to-cypress.php">Previous Page </a><span> | </span><a href="/distance-to-benton.php"> Next Page</a>
</div>
...
<aside>
    <div id="city">
        <h1>Employees Drive Time to Ana</h1>
        <hr>
