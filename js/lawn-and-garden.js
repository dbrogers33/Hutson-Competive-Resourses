var map;
    function initMap() {
        ...
        var tapps  = {lat: 37.05706, lng: -88.584242};
        var seaford  = {lat: 36.869566, lng: -88.350812};
        var hills  = {lat: 36.41152, lng: -89.072658};
        var hopkinsville  = {lat: 36.882868, lng: -87.481323};
        var montgomery  = {lat: 36.45878, lng: -87.238558};
        var hodge = {lat: 37.497568, lng: -87.944947};
        var motorsports  = {lat: 38.412609, lng: -86.938273};
        var murrayHome  = {lat: 36.617163, lng: -88.311338};
        var mayfieldLawn  = {lat: 36.743085, lng: -88.628064};
        var garlandsBad  = {lat: 36.801608, lng: -87.471865};
        var garlandsPowersports  = {lat: 36.847676, lng: -87.485475};
        var trovers  = {lat: 37.501265, lng: -88.806055};
        var andys  = {lat: 37.686824, lng: -87.914347};
        var superbike  = {lat: 37.993849, lng: -87.475766};
        var polaris  = {lat: 36.872509, lng: -88.347049};
        var heartland  = {lat: 37.0911, lng: -88.724542};
        var johnsons  = {lat: 37.237485, lng: -87.472815};
        var toddHorton  = {lat: 37.673682, lng: -88.554676};
        var martins  = {lat: 37.448296, lng: -89.142802};
        var powerEquipment  = {lat: 37.980174, lng: -87.593476};
        var boonvilleLawn  = {lat: 38.048387, lng: -87.287335};
        var treads  = {lat: 37.092834, lng: -88.63217};
        var cfi  = {lat: 37.004941, lng: -88.39339};
        var agrilife  = {lat: 37.600029, lng: -88.978827};
        var aone  = {lat: 37.977238, lng: -87.402301};
        var hagens  = {lat: 38.498974, lng: -86.73303};
        var hoefling  = {lat: 38.656168, lng: -87.127727};
        var daniel  = {lat: 36.845034, lng: -87.15769};
        var commercial  = {lat: 36.595147, lng: -87.27482};
        var montgomeryFarmers  = {lat: 36.554076, lng: -87.322695};
        var lawncutters  = {lat: 36.843635, lng: -87.476755};
        var redRivers  = {lat: 36.539917, lng: -87.340283};
        var stanley  = {lat: 37.381164, lng: -87.657828};
        var taylor  = {lat: 37.849278, lng: -87.582152};
        var scotty  = {lat: 38.173515, lng: -87.547509};
        var nix  = {lat: 38.169837, lng: -87.79027};
        var topdog  = {lat: 38.650198, lng: -87.177086};
        var allseasons  = {lat: 38.15793, lng: -87.081208};
        var airWorks  = {lat: 38.872758, lng: -87.086418};
        var fortnerOne  = {lat: 36.868031, lng: -87.792743};
        var richards  = {lat: 36.979568, lng: -88.676715};
        var fortnerTwo  = {lat: 37.108478, lng: -87.930816};
        var fortnerThree  = {lat: 37.354482, lng: -87.540878};
        ...
        //Tapps Outdoor Equipment Paducah KY - Gravely
        var tappsMarker = new google.maps.Marker({
            position: tapps,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Tapps Outdoor Equipment - Paducah, KY',
        });
        
        tappsMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Tapps Outdoor Equipment</h1><hr>'+ 
            '<h3>Paducah, KY</h3>'+
            '<ul><li>Gravely</li></ul>';
        });
        
        //Seaford Lawn & Garden Benton KY - Gravely
        var seafordMarker = new google.maps.Marker({
            position: seaford,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Seaford Lawn & Garden - Benton, KY',
        });
        
        seafordMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Seaford Lawn & Garden</h1><hr>'+ 
            '<h3>Benton, KY</h3>'+
            '<ul><li>Gravely</li></ul>';
        });
        
        //Hills Hardware Union City - Gravely
        var hillsMarker = new google.maps.Marker({
            position: hills,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Hills Hardware - Union City, TN',
        });
        
        hillsMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Hills Hardware</h1><hr>'+ 
            '<h3>Union City, TN</h3>'+
            '<ul><li>Gravely</li></ul>';
        });
        
        //Hopkinsville Outdoor Equipment Hopkinsville KY - Gravely
        var hopkinsvilleMarker = new google.maps.Marker({
            position: hopkinsville,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Hopkinsville Outdoor Equipment - Hopkinsville, KY',
        });
        
        hopkinsvilleMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Hopkinsville Outdoor Equipment</h1><hr>'+ 
            '<h3>Hopkinsville, KY</h3>'+
            '<ul><li>Gravely, Ferris</li></ul>';
        });
        
        //Montgomery County Euqipoment Clarksville TN - Gravely
        ...
        //Hodge Sales & Service - Gravely
        var hodgeMarker = new google.maps.Marker({
            position: hodge,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Hodge Sales & Service - Sturgis, KY',
        });
        
        hodgeMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Hodge Sales & Service</h1><hr>'+ 
            '<h3>Sullivan, KY</h3>'+
            '<ul><li>Gravely, Scagg</li></ul>';
        });
        
        //Motorsports By Batteries Now Jasper IN - Gravely
        var motorsportsMarker = new google.maps.Marker({
            position: motorsports,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Motorsports By Batteries Now - Jasper, IN',
        });
        
        motorsportsMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Motorsports By Batteries Now<h1><hr>'+ 
            '<h3>Jasper, IN</h3>'+
            '<ul><li>Gravely</li></ul>';
        });
        
        //Murray Home and Auto Murray, KY - Bad Boy
        var murrayHomeMarker = new google.maps.Marker({
            position: murrayHome,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Murray Home and Auto - Murray, KY',
        });
        
        murrayHomeMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Murray Home and Auto<h1><hr>'+ 
            '<h3>Murray, KY</h3>'+
            '<ul><li>Bad Boy, Scag</li></ul>';
        });
        
        //Mayfield Lawn & Garden Mayfield KY - Bad Boy
        var mayfieldLawnMarker = new google.maps.Marker({
            position: mayfieldLawn,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Mayfield Lawn & Garden - Mayfield, KY',
        });
        
        mayfieldLawnMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Mayfield Lawn & Garden<h1><hr>'+ 
            '<h3>Mayfield, KY</h3>'+
            '<ul><li>Bad Boy</li></ul>';
        });
    
        //Garland's Bad Boy Mowers Hopkinsville KY - Bad Boy
        var garlandsBadMarker = new google.maps.Marker({
            position: garlandsBad,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Garland\'s Bad Boy Mowers - Hopkinsville, KY',
        });
        
        garlandsBadMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Garland\'s Bad Boy Mowers<h1><hr>'+ 
            '<h3>Hopkinsville, KY</h3>'+
            '<ul><li>Bad Boy</li></ul>';
        });
        
        //Garland's Powersports Hopkinsville KY - Bad Boy
        var garlandsPowersportsMarker = new google.maps.Marker({
            position: garlandsPowersports,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Garland\'s Powersports - Hopkinsville, KY',
        });
        
        garlandsPowersportsMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Garland\'s Powersports<h1><hr>'+ 
            '<h3>Hopkinsville, KY</h3>'+
            '<ul><li>Bad Boy</li></ul>';
        });
        
        //Trover's Equipment Vienna IL - Bad Boy
        var troversMarker = new google.maps.Marker({
            position: trovers,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Trover\'s Equipment - Vienna, IL',
        });
        
        troversMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Trover\'s Equipment<h1><hr>'+ 
            '<h3>Vienna, IL</h3>'+
            '<ul><li>Bad Boy</li></ul>';
        });
        
        //Andy's Sales & Service Morganfield, KY - Bad Boy
        var andysMarker = new google.maps.Marker({
            position: andys,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Andy\'s Sales & Service - Morganfield, KY',
        });
        
        andysMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Andy\'s Sales & Service<h1><hr>'+ 
            '<h3>Morganfield, KY</h3>'+
            '<ul><li>Bad Boy</li></ul>';
        });
        
        //Superbike Shop Evansville, IN - Bad Boy
        var superbikeMarker = new google.maps.Marker({
            position: superbike,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Superbike Shop - Evansville, IN',
        });
        
        superbikeMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Superbike Shop<h1><hr>'+ 
            '<h3>Evansville, IN</h3>'+
            '<ul><li>Bad Boy</li></ul>';
        });
        
        //Polaris of Benton Benton KY - Ferris
        var polarisMarker = new google.maps.Marker({
            position: polaris,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Polaris of Beton - Benton, KY',
        });
        
        polarisMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Polaris of Benton<h1><hr>'+ 
            '<h3>Benton, KY</h3>'+
            '<ul><li>Ferris</li></ul>';
        });
        
        //Heartland Outdoor Equipment Paducah KY - Ferris
        var heartlandMarker = new google.maps.Marker({
            position: heartland,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Heartland Outdoor Equipment - Paducah, KY',
        });
        
        heartlandMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Heartland Outdoor Equipment<h1><hr>'+ 
            '<h3>Paducah, KY</h3>'+
            '<ul><li>Ferris</li></ul>';
        });
        
        //Johnson's Sales & Service Mortons Gap KY - Ferris
        var johnsonsMarker = new google.maps.Marker({
            position: johnsons,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Johnson\'s Sales & Service - Mortons Gap, KY',
        });
        
        johnsonsMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Johnson\'s Sales & Service<h1><hr>'+ 
            '<h3>Mortons Gap, KY</h3>'+
            '<ul><li>Ferris, Scagg</li></ul>';
        });
        
        //Todd Horton Small Engine Sales Harrisburg IL - Ferris
        var toddHortonMarker = new google.maps.Marker({
            position: toddHorton,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Todd Horton Small Engine Sales - Harrisburg, IL',
        });
        
        toddHortonMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Todd Horton Samll Engine Sales<h1><hr>'+ 
            '<h3>Harrisburg, IL</h3>'+
            '<ul><li>Ferris</li></ul>';
        });
        
        //Martin's Sharp-All Shop Anna, IL - Ferris
        var martinsMarker = new google.maps.Marker({
            position: martins,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Martin\'s Sharp-All Shop - Anna, IL',
        });
        
        martinsMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Martin\'s Sharp-All Shop<h1><hr>'+ 
            '<h3>Anna, IL</h3>'+
            '<ul><li>Ferris</li></ul>';
        });
        
        //Power Equipment Plus Evansville, IN - Ferris
        var powerEquipmentMarker = new google.maps.Marker({
            position: powerEquipment,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Power Equipment Plus - Evansville, IN',
        });
        
        powerEquipmentMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Power Equipment Plus<h1><hr>'+ 
            '<h3>Evansville, IN</h3>'+
            '<ul><li>Ferris</li></ul>';
        });
        
        //Booneville Lawn & Garden Booneville IN - Ferris
        var boonvilleLawnMarker = new google.maps.Marker({
            position: boonvilleLawn,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Boonville Lawn & Garden - Boonville, IN',
        });
        
        boonvilleLawnMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Boonville Lawn & Garden<h1><hr>'+ 
            '<h3>Boonville, IN</h3>'+
            '<ul><li>Ferris, Scagg</li></ul>';
        });
        
        //Treads Services Paducah KY - eXmark
        var treadsMarker = new google.maps.Marker({
            position: treads,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Treads Services - Paducah, KY',
        });
        
        treadsMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Treads Services<h1><hr>'+ 
            '<h3>Paducah, KY</h3>'+
            '<ul><li>eXmark</li></ul>';
        });
        
        //C.F.I. Inc Calvert City - eXmark
        var cfiMarker = new google.maps.Marker({
            position: cfi,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'C.F.I. Inc - Calvert City, KY',
        });
        
        cfiMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>C.F.I. Inc<h1><hr>'+ 
            '<h3>Calvert City, KY</h3>'+
            '<ul><li>eXmark</li></ul>';
        });
        
        //Agri-Life Products Goreville, IN - eXmark
        var agrilifeMarker = new google.maps.Marker({
            position: agrilife,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Agri-Life Products - Goreville, IL',
        });
        
        agrilifeMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Agri-Life Products<h1><hr>'+ 
            '<h3>Goreville, IL</h3>'+
            '<ul><li>eXmark</li></ul>';
        });
        
        //A-1 Power Newburgh IN - eXmark
        var aoneMarker = new google.maps.Marker({
            position: aone,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'A-1 Power - Newburgh, IN',
        });
        
        aoneMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>A-1 Power<h1><hr>'+ 
            '<h3>Newburgh, IN</h3>'+
            '<ul><li>eXmark, Scagg</li></ul>';
        });
        
        //Hagen's Repair Shop - eXmark
        var hagensMarker = new google.maps.Marker({
            position: hagens,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Hagen\'s Repair Shop - Dubois, IN',
        });
        
        hagensMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Hagen\'s Repair Shop<h1><hr>'+ 
            '<h3>Dubois, IN</h3>'+
            '<ul><li>eXmark</li></ul>';
        });
        
        //Hoefling Cycle Sales Washington IN - eXmark
        var hoeflingMarker = new google.maps.Marker({
            position: hoefling,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Hoefling Cycle Sales - Washington, IN',
        });
        
        hoeflingMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Hoefling Cycle Sales<h1><hr>'+ 
            '<h3>Washington, IN</h3>'+
            '<ul><li>eXmark</li></ul>';
        });
        
        //Daniel Garage Elkton KY - eXmark
        var danielMarker = new google.maps.Marker({
            position: daniel,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Daniel Garage - Elkton, KY',
        });
        
        danielMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Daniel Garage<h1><hr>'+ 
            '<h3>Elkton, KY</h3>'+
            '<ul><li>eXmark</li></ul>';
        });
        
        //Commercial Lawn Equipment - eXmark
        var commercialMarker = new google.maps.Marker({
            position: commercial,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Commercial Lawn Equipment - Clarksville, TN',
        });
        
        commercialMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Commercial Lawn Equipment<h1><hr>'+ 
            '<h3>Clarlksville, TN</h3>'+
            '<ul><li>eXmark</li></ul>';
        });
        ...
        //Montgomery Farmers Coop Clarksville TN - eXmark
        var montgomeryFarmersMarker = new google.maps.Marker({
            position: montgomeryFarmers,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Montgomery Farmers Coop - Clarksville, TN',
        });
        
        montgomeryFarmersMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Montgomery Farmers Co-op<h1><hr>'+ 
            '<h3>Clarksville, TN</h3>'+
            '<ul><li>eXmark</li></ul>';
        });
        
        //Lawncutters Equipment Hopkinsville KY - Scagg
        var lawncuttersMarker = new google.maps.Marker({
            position: lawncutters,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Lawn Cutters Equipment - Hopkinsville, KY',
        });
        
        lawncuttersMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Lawn Cutters Equipment<h1><hr>'+ 
            '<h3>Hopkinsville, KY</h3>'+
            '<ul><li>Scagg</li></ul>';
        });
        
        //Red Rivers Equipment Clarksville TN - Scagg
        var redRiversMarker = new google.maps.Marker({
            position: redRivers,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Red Rivers Equipment - Clarksville, TN',
        });
        
        redRiversMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Red Rivers Equipment<h1><hr>'+ 
            '<h3>Clarksville, TN</h3>'+
            '<ul><li>Scagg</li></ul>';
        });
        
        //Stanley & Son - Scagg
        var stanleyMarker = new google.maps.Marker({
            position: stanley,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Stanley & Son - Nebo, KY',
        });
        
        stanleyMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Stanley & Son<h1><hr>'+ 
            '<h3>Nebo, KY</h3>'+
            '<ul><li>Scagg</li></ul>';
        });
        
        //Taylor's Lawnmowers Henderson KY - Scagg
        var taylorMarker = new google.maps.Marker({
            position: taylor,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Taylor\'s Lawnmowers - Henderson, KY',
        });
        
        taylorMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Taylor\'s Lawnmowers<h1><hr>'+ 
            '<h3>Henderson, KY</h3>'+
            '<ul><li>Scagg</li></ul>';
        });
        
        //Scotty's Lawn Equipment - Scagg
        var scottyMarker = new google.maps.Marker({
            position: scotty,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Scotty\'s Lawn Equipment - Haubstadt, IN',
        });
        
        scottyMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Scotty\'s Lawn Equipment<h1><hr>'+ 
            '<h3>Haubstadt, IN</h3>'+
            '<ul><li>Scagg</li></ul>';
        });
        
        //Nix Equipment Poseyville, IN - Scagg
        var nixMarker = new google.maps.Marker({
            position: nix,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Nix Equipment - Poseyville, IN',
        });
        
        nixMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Nix Equipment<h1><hr>'+ 
            '<h3>Poseyville, IN</h3>'+
            '<ul><li>Scagg</li></ul>';
        });
        
        //Top Dog Lawn Care Washington IN - Scagg
        var topdogMarker = new google.maps.Marker({
            position: topdog,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Top Dog Lawn Care - Washington, IN',
        });
        
        topdogMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Top Dog Lawn Care<h1><hr>'+ 
            '<h3>Washington, IN</h3>'+
            '<ul><li>Scagg</li></ul>';
        });
        
        //All Seasons Lawn Dale IN - Scagg
        var allseasonsMarker = new google.maps.Marker({
            position: allseasons,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'All Seasons Lawn - Dale, IN',
        });
        
        allseasonsMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>All Seasons Lawn<h1><hr>'+ 
            '<h3>Dale, IN</h3>'+
            '<ul><li>Scagg</li></ul>';
        });
        
        //Air Works III - Scagg
        var airWorksMarker = new google.maps.Marker({
            position: airWorks,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Air Works III - Odon, IN',
        });
        
        airWorksMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Air Works III<h1><hr>'+ 
            '<h3>Odon, IN</h3>'+
            '<ul><li>Scagg</li></ul>';
        });
        
        //Fortner LP Gas Co Cadiz KY - Dixie Chopper
        var fortnerOneMarker = new google.maps.Marker({
            position: fortnerOne,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Fortner LP Gas Co. - Cadiz, KY',
        });
        
        fortnerOneMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Fortner LP Gas Co.<h1><hr>'+ 
            '<h3>Cadiz, KY</h3>'+
            '<ul><li>Dixie Chopper</li></ul>';
        });
        
        //Richard's Small Engine Paducah KY - Dixie Chopper
        var richardsMarker = new google.maps.Marker({
            position: richards,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Richard\'s Small Engine - Paducah, KY',
        });
        
        richardsMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Richard\'s Small Engine<h1><hr>'+ 
            '<h3>Paducah, KY</h3>'+
            '<ul><li>Dixie Chopper</li></ul>';
        });
        
        //Fortner LP Gas Co Princeton KY - Dixie Chopper
        var fortnerTwoMarker = new google.maps.Marker({
            position: fortnerTwo,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Fortner LP Gas Co. - Princeton, KY',
        });
        
        fortnerTwoMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Fortner LP Gas Co.<h1><hr>'+ 
            '<h3>Princeton, KY</h3>'+
            '<ul><li>Dixie Chopper</li></ul>';
        });
        
        //Fortner LP Gas Co Madisonville KY - Dixie Chopper
        var fortnerThreeMarker = new google.maps.Marker({
            position: fortnerThree,
            map: map,
            animation: google.maps.Animation.DROP,
            title: 'Fortner LP Gas Co. - Madisonville, KY',
        });
        
        fortnerThreeMarker.addListener('click', function() {
            document.getElementById("city").innerHTML = '<h1>Fortner LP Gas Co.<h1><hr>'+ 
